# X/Twitter Thread: ai4wechat

> Platform: X (Twitter)
> Language: English
> Attach: screenshot to tweet 1
...
- Typing indicator → "对方正在输入中" while AI processes
...
Text messaging is production-ready. Image/file sending is protocol-verified (CDN upload with AES-128-ECB) and on the roadmap.

---

## Tweet 5

GitHub: github.com/ai4wechat/ai4wechat
